    ...
    public function checkVersion()
    {
        try {
            ...
            if (!empty($c['admin']) && (empty($this->time) || ((time() - $this->time) > 3600))) {
                ...
                $last       = file_get_contents("https://raw.githubusercontent.com/ang3el7z/kkk-go-bot/$b/version");
                        ...
                        foreach ($c['admin'] as $k => $v) {
                            $this->send($v, implode("\n", $diff), 0, [
                                [
                                    [
                                        'text'    => 'changelog',
                                        'web_app' => ['url' => "https://raw.githubusercontent.com/ang3el7z/kkk-go-bot/$b/version"],
                                    ],
                                    [
